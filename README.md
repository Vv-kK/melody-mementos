...
- ItemCard: widget kustom yang merepresentasikan tiap item
...
- ThemeData: widget untuk mengatur tampilan dari keseluruhan aplikasi
- MyHomePage: widget kustom yang dibuat untuk tampilan utama dari aplikasi
