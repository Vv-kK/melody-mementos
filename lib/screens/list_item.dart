...
import 'dart:convert';
import 'package:melody_mementos/models/item.dart';
import 'package:melody_mementos/widgets/left_drawer.dart';
import 'package:melody_mementos/screens/detail.dart';
...
Future<List<Item>> fetchProduct() async {
    ...
    var url = Uri.parse(
        'http://veronica-kylie-tugas.pbp.cs.ui.ac.id/json/');
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => Detail(
                                      ...
                                      artist: snapshot.data![index].fields.artist,
